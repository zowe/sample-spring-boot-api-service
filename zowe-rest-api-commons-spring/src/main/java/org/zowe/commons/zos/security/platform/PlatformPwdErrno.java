...
public enum PlatformPwdErrno {
    ...
    private static Map<Integer, PlatformPwdErrno> BY_ERRNO = new HashMap<>();
    ...
    private PlatformPwdErrno(String name, int errno, String explanation, PlatformErrorType errorType) {
        this.name = name;
        this.errno = errno;
