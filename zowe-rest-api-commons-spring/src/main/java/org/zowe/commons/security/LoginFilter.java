...
public class LoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public LoginFilter(
        String authEndpoint,
        ObjectMapper mapper,
        AuthenticationManager authenticationManager, AuthenticationSuccessHandler successHandler, AuthConfigurationProperties authConfigurationProperties) {
        super(authEndpoint);
        this.mapper = mapper;
    ...
    private Optional<LoginRequest> getCredentialFromAuthorizationHeader(HttpServletRequest request) {
        return Optional.ofNullable(
            ...
            header -> header.replaceFirst(authConfigurationProperties.getBasicAuthenticationPrefix(), "").trim()
        )
