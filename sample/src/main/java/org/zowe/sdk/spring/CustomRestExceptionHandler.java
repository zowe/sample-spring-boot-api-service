...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    private static final String INTERNAL_SERVER_ERROR_MESSAGE_KEY = "org.zowe.sdk.rest.internalServerError";

    private final ErrorService errorService = SdkErrorService.get();

    @Override
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
            HttpHeaders headers, HttpStatus status, WebRequest request) {
        ApiMessage message = errorService.createApiMessage("org.zowe.sdk.rest.methodNotAllowed");
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
        ...
        ApiMessage message = errorService.createApiMessage("org.zowe.sdk.rest.notFound");
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
            HttpHeaders headers, HttpStatus status, WebRequest request) {
        ApiMessage message = errorService.createApiMessage("org.zowe.sdk.rest.unsupportedMediaType");
    ...
    public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
        ...
        log.error(SdkErrorService.getReadableMessage(message), ex);
